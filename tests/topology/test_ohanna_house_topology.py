"""Tests for the Ohanna-House topology definition."""
...
def test_ohanna_house_topology_has_expected_identity() -> None:
    """The topology must identify Ohanna-House."""
...
def test_ohanna_house_topology_contains_expected_devices() -> None:
...
def test_ohanna_house_topology_contains_expected_links() -> None:
...
def test_ohanna_house_backbone_is_ten_gigabit() -> None:
...
def test_ohanna_house_rpi_link_uses_wifi() -> None:
...
def test_ohanna_house_runtime_devices_reference_nodes() -> None:
...
def test_ohanna_house_network_devices_have_expected_kinds() -> None:
...
def test_ohanna_house_topology_has_physical_layout() -> None:
