"""Ohana-House infrastructure topology definition."""
...
def build_ohana_house_topology() -> Topology:
    """Build the physical topology of Ohana-House."""
    return Topology(
        ...
        metadata={
            "description": ("Physical infrastructure topology of Ohana-House."),
            "version": 1,
        },
    )
...
def _build_links() -> tuple[TopologyLink, ...]:
    """Build physical links between Ohana-House devices."""
...
def _build_physical_layout() -> TopologyLayout:
    ...
    return TopologyLayout(
        layout_id="ohana-house-physical",
