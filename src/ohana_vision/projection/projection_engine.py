...
from ohana_vision.projection.capability_reducer import CapabilityReducer
from ohana_vision.projection.infrastructure_reducer import (
    InfrastructureReducer,
)
from ohana_vision.projection.node_reducer import NodeReducer
from ohana_vision.projection.service_reducer import ServiceReducer
