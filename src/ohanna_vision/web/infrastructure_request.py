...
class InfrastructureTopologyDeviceRequest(BaseModel):
    """Device displayed in a topology supplied by Ohanna-Agent."""
...
class InfrastructureTopologyLinkRequest(BaseModel):
    """Link displayed in a topology supplied by Ohanna-Agent."""
...
class InfrastructureTopologyLayoutRequest(BaseModel):
    """Logical layout supplied by Ohanna-Agent."""
...
class InfrastructureTopologyRequest(BaseModel):
    """Complete topology definition supplied by Ohanna-Agent."""
